...
public class runner {
	...
	public static void main(String[] args) {
		...
		while (selection != 3) {
			System.out.println("Select Iterative [1] or Recursive [2] by typing the desired letter. Type [3] to exit.");
			...
			{
				System.out.println("Invalid selection. Select Iterative [1] or Recursive [2] by typing the desired letter. Type [3] to exit.");
				selection = userInput.nextInt();
			}
		}
		userInput.close();
