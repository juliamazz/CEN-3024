...
public class WordCounter {
	...
	public static Word[] wordCounter() {
		...
		Word[] sortedByWordList = processString(cleanedString);

		// Sort that list by frequency 
		Word[] sortedByFrequencyList = processList(sortedByWordList);

		return sortedByFrequencyList;
	}
	
	/**
	 * Input Processing Stage
	 */
	public static StringBuilder processInput(String inputUrl, String poemTitle, String poemEnding)
	{
	...
	public static Word[] processString(String formattedString)
	{
		...
		for (int i = 0; i < separateStrings.length; i++)
		{
			...
			String curWord = separateStrings[i];
	 ...
	 */
	public static Word[] processList(Word[] sortedWordList)
	{	
